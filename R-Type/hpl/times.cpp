...
namespace hpl
{
	...
	Time::Content::Content(llint second, llint milisecond) : sec(second), mili(milisecond) {}
	...
	Time	Time::Millisecond(llint time) { return (Time(Content(time / 1000, time - time / 1000 * 1000))); }
	Time	Time::Second(llint time) { return (Time(Content(time, 0))); }
